						...
						echo '<div class="col-sm-3">
							<div class="product-div">
								<div class="singleproducts">
										<img class="full-fit" src="'.$res['image'].'" alt="$res" />
			 							<p class="prodtitle">'.$$res['name'].'</p>
											<span class="dealprice pull-left">'.$res['price'].'</span>
											<span class="sellingprice pull-right">'.$res['sellingprice'].'</span><br/><br/><br/>
											<span class="comapnylabel">'.$res['parentsite'].'</span><br/> 
											<span class="coupon">'.$res['coupon'].'</span><br/> 
										<a href="prod?pid='.$res['productid'].'" class="btn btn-default pull-left color-blue">View Deal</a>
										<a href="'.$res['href'].'" class="btn btn-default pull-right color-orange">Direct Visit</a>
