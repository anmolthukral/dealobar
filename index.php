		...
		<div class="container">
			...
			<h2 >Category</h2>
			  ...
			  <div class="navbar-header">
						<div class="panel-group category-products" id="categoies"><!--category-productsr-->
							<?php
							/*include ('databaseadapter.php');
							$select="SELECT catergory FROM category;";
							$result=mysql_query($select);
							if($result){
							while ($res=mysql_fetch_array($result)) {
							echo '	<div class="panel panel-default" >
								<div class="panel-heading">
									<h4 class="panel-title"><a href="category?cat='.$res["catergory"].'">'.$res["catergory"].'</a></h4>
								</div>
							</div>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php
						/*include("databaseadapter.php");
						$querytogetproducts="SELECT * FROM products ORDER BY dateposted DESC LIMIT 0,16;";
						...
						echo '<div class="col-sm-3">
							<div class="product-div">
								<div class="singleproducts">
										<img class="full-fit" src="'.$img.'" alt="$res" />
			 							<p class="prodtitle">'.$res.'</p>
											<span class="dealprice pull-left">'.$res.'</span>
											<span class="sellingprice pull-right">'.$res.'</span><br/><br/><br/>
											<span class="comapnylabel">'.$res.'</span><br/> 
											<span class="coupon">'.$res.'</span><br/> 
										<a href="prod?pid='.$res.'" class="btn btn-default pull-left color-blue">View Deal</a>
										<a href="'.$res.'" class="btn btn-default pull-right color-orange">Direct Visit</a>
